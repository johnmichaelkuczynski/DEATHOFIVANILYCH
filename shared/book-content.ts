...
2.0 Two kinds of goodness: instrumental and intrinsic
...
There are two kinds of goodness: instrumental good and intrinsic good. To say that an act is instrumentally good is to say that it has consequences that are desired by, or to the advantage of, the agent. (The agent is the person who commits the act.) So if my sole objective is to make money, it is instrumentally good, at least as far as my interests are concerned, to steal a million dollars from a local orphanage (provided that I don’t get caught or otherwise get into trouble for doing so). So stealing money from the orphanage is instrumentally good. That is to say, it is useful: it has consequences that are to my advantage; it is in my practical interest to act in that way.
...
If something is good in a non-instrumental sense, it is intrinsically good. Ethics is concerned with intrinsic goodness. It attempts to answer the question “which things are intrinsically good?” Ethics is not interested in instrumental (i.e., strategic or pragmatic) goodness. Ethics is not interested in identifying ways that thieves can steal more or ways that crooked politicians can acquire more power. Ethics is interested in identifying those courses of action, and those states of affairs, that are good even if their consequences are disregarded.
...
2.1 Instrumental and intrinsic goodness not mutually exclusive
...
3.0 More meanings of the word “good’: goodness vs. commendableness, badness vs. condemnableness
...
3.1 Two kinds of intrinsic badness
...
4.0 The morally complex structure of some situations
...
5.0 The non-privative character of moral attributes
...
For something to be cold is for it to lack heat. For something to be dumb is for it to lack intelligence. For something to be poor is for it to lack money. To be dumb or cold or poor is to lack something. There are many properties like this: in other words, where many properties are concerned, having them is identical with failing to have some other property.
...
6.0 A corollary of the non-binary nature of moral attributes: Moral obligations have a dimension of weight
...
6.2 “right” ≠ “good”, “right” = “least bad”
...
6.3 “wrong” ≠ “bad”, “wrong” = “least good”
...
9.0 The moral status of passing judgment on X ≠ to the moral status of X itself
...
For similar reasons, even if an act is condemnable, one doesn’t necessarily have the right to describe it as such. One has that right only if one has sufficient information about the act. If, without having such information,
...
10.0 The goodness of the act vs. the goodness of the agent
...
It’s obvious that Mary didn’t do “the right thing.” In other words, she didn’t act in a way that maximized human welfare and minimized violations of human rights. But is Mary morally worse than Kathy? In other words, is Mary to be judged more harshly than Kathy? In fact, is Mary any less worthy of praise than Kathy?
...
12.0 Aren’t there people who are to be condemned even though it is their intention to do good?
...
13.0 Can one act immorally towards oneself?

This is a controversial issue; but my feeling is “yes.” One can sell oneself short; one act self-destructively. One can do things to oneself that it is one’s right not to undergo.
...
14.1 You can’t derive an “ought” from an “is”
...
14.2 Moore’s “open question” argument
...
Here is his argument. Premise: No matter how many valuative truths you know about x, it remains an “open question” whether x is good or not. Conclusion: Ethical truths are not identical with, or otherwise “reducible to,” factual statements.
...
14.2.1 Commentary on the last two principles
...
Unlike (1) and (2), (3) is at least partly correct—maybe even 100% correct. But there is still some reason to doubt it. Suppose that you give me $10,000 to move some rocks for you. Before I move the rocks, I spend the money. Then, when I try to move the rocks, it turns out I can’t. I’m not strong enough (or my truck doesn’t have enough horse power, or whatever). It still seems that I have an obligation to move the rocks (or to refund the money—but maybe I can no more refund the money than I can move the rocks). In any case, (3) is at least approximately correct.

14.4 Genetic questions must be distinguished from normative questions
...
14.6 Questions concerning morality must be separated from questions concerning the implementation of moral principles
...
These questions may seem trivial. But, if so, that’s precisely because it is so clear how they are to be answered. The illusion that there is no moral agreement—when, in fact, such agreement is less the exception than the rule—is that an ethical issue isn’t worth discussing anymore if there is universal agreement about it. For this reason, the only ethical issues that are worth discussing are the ones that haven’t been solved, giving rise to the misleading appearance that there is no ethical agreement.

15.4 Discussion of (iv)
